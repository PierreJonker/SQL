...
FROM 'C:\Bootcamp\Java_Bootcamp\SQL\My_Work\Chapter4\us_counties_2010.csv'
WITH (FORMAT CSV, HEADER);
...
FROM 'C:\Bootcamp\Java_Bootcamp\SQL\My_Work\Chapter4\supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);
...
COPY us_counties_2010
TO 'C:\Bootcamp\Java_Bootcamp\SQL\My_Work\Chapter4\us_counties_export.txt'
...
TO 'C:\Bootcamp\Java_Bootcamp\SQL\My_Work\Chapter4\us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
TO 'C:\Bootcamp\Java_Bootcamp\SQL\My_Work\Chapter4\us_counties_mill_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
